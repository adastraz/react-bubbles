...
A token is sort of like a key for users. A login is a username and password, each user gets their own token, they can access their own data on that site. used to access protected pages

- [ ] What steps can you take in your web apps to keep your data secure?

An encryption key! This is to protect username and passwords as the packets are sent to and from the user to the server.  

- [ ] Describe how web servers work.

A computer or groupage of computers that store the website, the user details, etc. Everything for that site is run through it's web server. You no longer have to have these 'groupage' of computers in your possession, you can now get servers through platforms like google
